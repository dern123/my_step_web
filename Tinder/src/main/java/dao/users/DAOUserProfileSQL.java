...
public class DAOUserProfileSQL implements UserProfileDAO {
    private final Connection conn;
    private List<UserProfile> profiles;
    public DAOUserProfileSQL(Connection conn) {
        this.conn = conn;
...
//    }
    ...
    @Override
    public void save(UserProfile s) throws SQLException {
        PreparedStatement st;
//        if (s.group().isPresent()) {
            String insert = "insert into student (name, photoUrl) values (?, ?, ?)";
            st = conn.prepareStatement(insert);
            st.setString(1, s.getName());
            st.setString(2, s.getPhotoUrl());
//        } else {
...
//        }
    ...
    @Override
    public Optional<UserProfile> find(int id) throws SQLException {
        String select = "select id, name, photoUrl from student where id = ?";
        PreparedStatement st = conn.prepareStatement(select);
        st.setInt(1, id);
        ResultSet rs = st.executeQuery();
        if (rs.next()) {
            UserProfile student = UserProfile.fromRs(rs);
    ...
    public List<UserProfile> findAll() throws SQLException {
        String select = "select id, name, photoUrl from student";
        PreparedStatement st = conn.prepareStatement(select);
        ResultSet rs = st.executeQuery();
        ArrayList<UserProfile> data = new ArrayList<>();
        while (rs.next()) data.add(UserProfile.fromRs(rs));
        return data;
    }
...
//    }
    ...
    @Override
    public void update(UserProfile s) throws SQLException {
        PreparedStatement st;
        String update = """
        UPDATE student
        SET
...
//
//    @Override
//    public List<Student> findSeniors() throws SQLException {
//        String select = "select id, name, groupp, salary from student where salary > 3000";
//        PreparedStatement st = conn.prepareStatement(select);
//        ResultSet rs = st.executeQuery();
//        ArrayList<Student> data = new ArrayList<>();
//        while (rs.next()) data.add(Student.fromRs(rs));
//        return data;
//    }
//
//    @Override
//    public List<Student> findMiddles() throws SQLException {
//        String select = "select id, name, groupp, salary from student where salary between 2000 and 3000";
//        PreparedStatement st = conn.prepareStatement(select);
//        ResultSet rs = st.executeQuery();
//        ArrayList<Student> data = new ArrayList<>();
//        while (rs.next()) data.add(Student.fromRs(rs));
...
//
//    @Override
//    public List<Student> findJuniors() throws SQLException {
//        String select = "select id, name, groupp, salary from student where salary < 2000";
//        PreparedStatement st = conn.prepareStatement(select);
//        ResultSet rs = st.executeQuery();
//        ArrayList<Student> data = new ArrayList<>();
//        while (rs.next()) data.add(Student.fromRs(rs));
